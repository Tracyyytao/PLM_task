...
if __name__ == '__main__':
    ...
    device = 'cpu'
    tokenizer = AutoTokenizer.from_pretrained("../../Huggingface/chatglm-6b", trust_remote_code=True)
    model = AutoModel.from_pretrained("../../Huggingface/chatglm-6b", trust_remote_code=True).half()
    model.to(device)
