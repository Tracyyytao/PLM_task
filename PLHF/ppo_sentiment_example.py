...
config = {
    "model_name": '../Huggingface/gpt2-chinese-cluecorpussmall',
    "steps": 20000,
    "batch_size": 128,
...
# 情感分类模型
senti_tokenizer = AutoTokenizer.from_pretrained('../Huggingface/roberta-base-finetuned-jd-binary-chinese')
senti_model = AutoModelForSequenceClassification.from_pretrained('../Huggingface/roberta-base-finetuned-jd-binary-chinese')
...
for epoch in tqdm(range(total_ppo_epochs)):
    ...
    if epoch % config['save_freq'] == 0:
        ...
        # 添加 safe_serialization=False 来避免保存共享权重时报错
