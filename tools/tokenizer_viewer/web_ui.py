...
3. encode 和 decode 功能测试。
    ...
    if btn:
        with st.spinner('Loading tokenizer...'):
            ...
            st.session_state['current_tokenizer_vocab'] = sort_vocab_by_index(
                st.session_state['current_tokenizer'].get_vocab())
            st.session_state['current_tokenizer_vocab_list'] = list(st.session_state['current_tokenizer_vocab'].keys())
            st.session_state['current_tokenizer_vocab_df'] = get_vocab_dataframe(
                st.session_state['current_tokenizer_vocab'])
            st.session_state['current_tokenizer_added_vocab'] = sort_vocab_by_index(
                st.session_state['current_tokenizer'].get_added_vocab())
            st.session_state['current_tokenizer_added_vocab_list'] = list(
                st.session_state['current_tokenizer_added_vocab'].keys())
            st.session_state['current_tokenizer_added_vocab_df'] = get_vocab_dataframe(
                st.session_state['current_tokenizer_added_vocab'])
    ...
    if st.session_state['current_tokenizer']:
        with st.expander('字符数统计', expanded=True):
            temp_dict = {
                ...
                'vocab_len': [len(st.session_state['current_tokenizer_vocab']) - len(
                    st.session_state['current_tokenizer_added_vocab'])],
...
def show_diff_area():
    ...
    tokenizer1_unique_token = set(st.session_state['diff_tokenizer_1_vocab_list']) - set(
        st.session_state['diff_tokenizer_2_vocab_list'])
    tokenizer2_unique_token = set(st.session_state['diff_tokenizer_2_vocab_list']) - set(
        st.session_state['diff_tokenizer_1_vocab_list'])
    ...
    if start_btn:
        ...
        if token_1_path_or_name and token_2_path_or_name:
            with st.spinner('Loading tokenizer...'):
                ...
                st.session_state['diff_tokenizer_1_vocab'] = sort_vocab_by_index(
                    st.session_state['diff_tokenizer_1'].get_vocab())
                st.session_state['diff_tokenizer_1_vocab_list'] = list(
                    st.session_state['diff_tokenizer_1_vocab'].keys())
                st.session_state['diff_tokenizer_1_vocab_df'] = get_vocab_dataframe(
                    st.session_state['diff_tokenizer_1_vocab'])
                st.session_state['diff_tokenizer_1_added_vocab'] = sort_vocab_by_index(
                    st.session_state['diff_tokenizer_1'].get_added_vocab())
                st.session_state['diff_tokenizer_1_added_vocab_list'] = list(
                    st.session_state['diff_tokenizer_1_added_vocab'].keys())
                st.session_state['diff_tokenizer_1_added_vocab_df'] = get_vocab_dataframe(
                    st.session_state['diff_tokenizer_1_added_vocab'])

                st.session_state['diff_tokenizer_2'] = load_tokenizer(token_2_path_or_name)
                st.session_state['diff_tokenizer_2_vocab'] = sort_vocab_by_index(
                    st.session_state['diff_tokenizer_2'].get_vocab())
                st.session_state['diff_tokenizer_2_vocab_list'] = list(
                    st.session_state['diff_tokenizer_2_vocab'].keys())
                st.session_state['diff_tokenizer_2_vocab_df'] = get_vocab_dataframe(
                    st.session_state['diff_tokenizer_2_vocab'])
                st.session_state['diff_tokenizer_2_added_vocab'] = sort_vocab_by_index(
                    st.session_state['diff_tokenizer_2'].get_added_vocab())
                st.session_state['diff_tokenizer_2_added_vocab_list'] = list(
                    st.session_state['diff_tokenizer_2_added_vocab'].keys())
                st.session_state['diff_tokenizer_2_added_vocab_df'] = get_vocab_dataframe(
                    st.session_state['diff_tokenizer_2_added_vocab'])
        else:
    ...
    if st.session_state['diff_tokenizer_1']:
        with st.expander('字符数统计', expanded=True):
            temp_dict = {
                ...
                'vocab_len': [
                    len(st.session_state['diff_tokenizer_1_vocab']) - len(
                        st.session_state['diff_tokenizer_1_added_vocab']),
                    len(st.session_state['diff_tokenizer_2_vocab']) - len(
                        st.session_state['diff_tokenizer_2_added_vocab']),
                    len(st.session_state['diff_tokenizer_1_vocab']) - len(
                        st.session_state['diff_tokenizer_1_added_vocab']) \
                    - len(st.session_state['diff_tokenizer_2_vocab']) + len(
                ...
                'added_vocab_len': [
                    ...
                    len(st.session_state['diff_tokenizer_1_added_vocab']) - len(
                        st.session_state['diff_tokenizer_2_added_vocab'])
                ],
                'all_vocab_len': [
