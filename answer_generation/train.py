...
parser.add_argument("--pretrained_model", default='../Huggingface/t5-small-chinese-cluecorpussmall', type=str,
                    help="backbone of encoder.")
parser.add_argument("--train_path", default='data/DuReaderQG/train.json', type=str, help="The path of train set.")
parser.add_argument("--dev_path", default='data/DuReaderQG/dev.json', type=str, help="The path of dev set.")
